...
class RenderData:
    ...
    Attributes:
        ...
        placement_positions: List of valid placement position strings for highlighting.
            Empty list if highlights not requested or no valid placements.
            Format: ['A1', 'B2', 'C3', ...]

        capture_moves: List of valid capture move dictionaries for highlighting.
            Empty list if highlights not requested or no valid captures.
            Format: [{'src': 'C4', 'dst': 'E6', 'marble': 'g', 'capture': 'D5'}, ...]

        removal_positions: Dictionary mapping position strings to blink status for removal highlighting.
            Empty dict if highlights not requested.
    ...
    def __init__(
        ...
        Args:
            ...
            placement_positions: List of valid placement positions (default: empty list)
            capture_moves: List of valid capture move dicts (default: empty list)
