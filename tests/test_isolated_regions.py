...
class TestIsolatedRegionCaptureRules:
    ...
    def test_isolated_single_ring_with_marble_captures(self, small_board):
        ...
        # Place marble on G1
        small_board.state[
            small_board.MARBLE_LAYERS.start, *zertz.algebraic_to_coordinate(small_board.config, "G1")
        ] = 1  # white

        # Remove G2 and F1 manually to prepare for isolation
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "G2")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "F1")] = 0

        # Now place a marble somewhere and remove F2 to isolate G1
        # Place on D4 (safe location), remove F2
        put_action = (
            0,
            # (lambda pos: pos[0] * small_board.config.width + pos[1])(algebraic_to_coordinate("D4")),
            *zertz.algebraic_to_coordinate(small_board.config, "D4"),
            # (lambda pos: pos[0] * small_board.config.width + pos[1])(algebraic_to_coordinate("F2")),
            *zertz.algebraic_to_coordinate(small_board.config, "F2")
        )
        ...
        assert (
            small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "G1")]
            == 0
        )
    ...
    def test_isolated_single_ring_vacant_remains_playable(self, small_board):
        ...
        assert zertz.algebraic_to_coordinate(small_board.config, "G1") in small_board._get_open_rings()
    ...
    def test_isolated_two_rings_all_occupied_captures(self, small_board):
        ...
        small_board.state[
            small_board.MARBLE_LAYERS.start + 1, *zertz.algebraic_to_coordinate(small_board.config, "G2")
        ] = 1  # grey
        ...
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "F1")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "F2")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "F3")] = 0

        # Place marble on D4, remove G3 to complete isolation
        put_action = (
            0,
            *zertz.algebraic_to_coordinate(small_board.config, "D4"),
            *zertz.algebraic_to_coordinate(small_board.config, "G3"),
        )
        ...
        assert (
            small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "G2")]
            == 0
        )
    ...
    def test_isolated_two_rings_one_vacant_remains_playable(self, small_board):
        ...
        small_board.state[
            small_board.MARBLE_LAYERS.start, *zertz.algebraic_to_coordinate(small_board.config, "G2")
        ] = 1  # white
        ...
        assert zertz.algebraic_to_coordinate(small_board.config, "G1") in open_rings
        assert zertz.algebraic_to_coordinate(small_board.config, "G2") not in open_rings  # occupied
    ...
    def test_placement_triggered_isolation_capture(self, small_board):
        ...
        """
        # Place marble on D7
        d7_idx = zertz.algebraic_to_coordinate(small_board.config, "D7")
        small_board.state[small_board.MARBLE_LAYERS.start, *d7_idx] = 1  # white

        # Remove D7's neighbors to isolate it: E6, C6, B5, C5, D6
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "E6")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "C6")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "B5")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "C5")] = 0
        small_board.state[small_board.RING_LAYER, *zertz.algebraic_to_coordinate(small_board.config, "D6")] = 0

        # Now place a marble somewhere else to trigger the isolation check
        # Place on C3, remove any removable ring
        put_action = (
            0,  # white marble
            *zertz.algebraic_to_coordinate(small_board.config, "C3"),
            *zertz.algebraic_to_coordinate(small_board.config, "G1")
        )
...
class TestPartiallyIsolatedRegionProperties:
    ...
    def test_isolated_region_appears_in_get_regions(self, small_board):
        ...
        # Find the G1 region
        g1_idx = zertz.algebraic_to_coordinate(small_board.config, "G1")
        g1_region = None
    ...
    def test_partially_isolated_ring_is_placeable(self, small_board):
        ...
        g1_y, g1_x = zertz.algebraic_to_coordinate(small_board.config, "G1")
...
class TestNoIsolation:
    ...
    def test_no_isolation_no_capture(self, small_board):
        ...
        # Place some marbles
        small_board.state[
            small_board.MARBLE_LAYERS.start, *zertz.algebraic_to_coordinate(small_board.config, "D4")
        ] = 1
        small_board.state[
            small_board.MARBLE_LAYERS.start + 1, *zertz.algebraic_to_coordinate(small_board.config, "E4")
        ] = 1
