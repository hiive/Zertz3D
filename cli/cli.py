"""Command-line interface for Zèrtz 3D."""
...
Player Configuration:
  ...
  Examples:
    ...
    parser.add_argument(
        "--replay",
        type=str,
        help="Path to transcript/notationre file (board size auto-detected)",
    )
    parser.add_argument(
        "--rings",
        type=int,
    ...
    parser.add_argument(
        "--games",
        type=int,
        help="Number of games to play (default: play indefinitely)",
    )
    parser.add_argument(
        "--highlight-choices",
